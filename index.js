...
var ASM_CONSTS = {
  539155548: () => { FS.syncfs(false, function (err) { assert(!err); }); },  
 539155600: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL); },  
 539155825: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 539155972: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 ...
 539156758: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
...
var _takeScreenShot = Module['_takeScreenShot'] = createExportWrapper('takeScreenShot', 0);
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 539005012;
